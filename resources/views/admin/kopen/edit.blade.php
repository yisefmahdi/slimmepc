<x-admin.layout title="Record bewerken">
    <div class="mb-6 flex items-center justify-between gap-3">
        <div>
            <h1 class="text-xl font-extrabold tracking-tight" style="color: var(--c-heading)">Record bewerken</h1>
            <p class="text-xs" style="color: var(--c-muted)">{{ $record->product_name }} · {{ $record->supplier_name }}</p>
        </div>
    ...
    <form action="{{ route('admin.purchase-sales.update', $record->id) }}" method="POST" class="space-y-6">
        @csrf
        @method('PUT')
            ...
            <div class="p-4 sm:p-6">
                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                    <div>
                        ...
                        <x-text-input id="product_name" name="product_name" value="{{ old('product_name', $record->product_name) }}" placeholder="Bijv. HP Laptop 15" />
                    ...
                    <div>
                        ...
                        <x-text-input id="supplier_name" name="supplier_name" value="{{ old('supplier_name', $record->supplier_name) }}" placeholder="Bijv. Tech BV" />
                    ...
                    <div>
                        ...
                        <x-text-input id="purchase_date" name="purchase_date" type="date" value="{{ old('purchase_date', $record->purchase_date instanceof \Carbon\Carbon ? $record->purchase_date->format('Y-m-d') : $record->purchase_date) }}" />
                    ...
                    <div>
                        ...
                        <x-text-input id="purchase_price" name="purchase_price" type="number" step="0.01" min="0" value="{{ old('purchase_price', $record->purchase_price) }}" placeholder="0.00" />
            ...
            <div class="p-4 sm:p-6">
                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                    <div class="sm:col-span-2">
                        ...
                        <x-text-input id="customer_name" name="customer_name" value="{{ old('customer_name', $record->customer_name) }}" placeholder="Bijv. Jan Jansen" />
                    ...
                    <div>
                        ...
                        <x-text-input id="sale_date" name="sale_date" type="date" value="{{ old('sale_date', $record->sale_date instanceof \Carbon\Carbon ? $record->sale_date->format('Y-m-d') : $record->sale_date) }}" />
                    ...
                    <div>
                        ...
                        <x-text-input id="sale_price" name="sale_price" type="number" step="0.01" min="0" value="{{ old('sale_price', $record->sale_price) }}" placeholder="0.00" />
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <textarea name="notes" id="notes" rows="3" placeholder="Extra opmerkingen..." class="form-input w-full text-sm">{{ old('notes', $record->notes) }}</textarea>
        ...
        <div class="flex items-center justify-end gap-3">
            ...
            <button type="submit" class="inline-flex h-11 items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-[#075be8] to-[#064bd7] px-8 text-sm font-bold text-white shadow-[0_10px_25px_rgba(0,91,234,0.25)] hover:-translate-y-0.5">Bijwerken</button>
        </div>
    </form>
</x-admin.layout>
