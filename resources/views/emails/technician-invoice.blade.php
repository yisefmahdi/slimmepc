...
@section('body')
<p style="margin:0 0 8px; font-size:14px; line-height:1.7; color:#3E547F;">Beste {{ $form->user->name }},</p>
<p style="margin:0; font-size:14px; line-height:1.7; color:#3E547F;">Bedankt voor je betaling! Hierbij ontvangt u in de bijlage de factuur van <strong style="color:#0b1734;">Slimme-PC</strong> voor de werkzaamheden bij u thuis ({{ $form->duration_minutes }} minuten). Heeft u vragen over deze factuur? Neem gerust contact met ons op.</p>
@endsection
...
<table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%">
  ...
  <tr>
    ...
    <td align="right" style="font-size:18px; font-weight:800; color:#2563eb; padding:10px 0 0; white-space:nowrap;">€{{ number_format($form->total, 2, ',', '.') }}</td>
  </tr>
</table>
@endsection
